...
export default function VotingPage() {
  ...
  const fetchCandidates = async () => {
    try {
      const response = await fetch('https://voting-back.vercel.app/candidate', {
        headers: {
  ...
  const fetchVoteCounts = async () => {
    try {
      const response = await fetch('https://voting-back.vercel.app/candidate/vote/count', {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
      });
  ...
  const fetchUserProfile = async () => {
    try {
      const response = await fetch('https://voting-back.vercel.app/user/profile', {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
      });
  ...
  const handleVote = async (candidateId) => {
    try {
      ...
      const response = await fetch(`https://voting-back.vercel.app/candidate/vote/${candidateId}`, {
        method: 'POST',
        headers: {
  ...
  const handlePasswordChange = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://voting-back.vercel.app/user/profile/password', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
